...
DEFAULT_LOG_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "ground_vel_log.csv")
DEFAULT_COMPARE_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "vel_comparison_report.csv")
...
def main():
    ...
    parser.add_argument(
        ...
        help="Replay comparison from a CSV file (default: tools/sub/vel/ground_vel_log.csv)"
    )
    parser.add_argument(
