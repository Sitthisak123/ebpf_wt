...
"""
    ...
    try:
        ...
        os.system("echo [pwd] | sudo -S mv /tmp/persistent-mouse.service /etc/systemd/system/")
        os.system("echo [pwd] | sudo -S systemctl daemon-reload")
        os.system("echo [pwd] | sudo -S systemctl enable persistent-mouse.service")
        os.system("echo [pwd] | sudo -S systemctl restart persistent-mouse.service")
